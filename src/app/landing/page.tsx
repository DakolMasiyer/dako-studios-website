...
export const metadata: Metadata = {
  ...
  description: 'Dako Studios builds websites and brand assets that actually convert — and hands you full ownership at launch. No retainer. Based in Abuja, serving Nigeria and the diaspora.',
